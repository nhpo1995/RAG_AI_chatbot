...
class DBService:
    ...
    def add_chunks_from_folder(self, list_folder_path: List[Path]) ->None:
        embedded_docs = self.processor.process_folder(folder_path=list_folder_path)
    ...
    def delete_chunks_from_list_file(self, list_file_path: List[Path]) ->None:
        for file_path in list_file_path:
            self.dbmanager.delete_file(file_path)
